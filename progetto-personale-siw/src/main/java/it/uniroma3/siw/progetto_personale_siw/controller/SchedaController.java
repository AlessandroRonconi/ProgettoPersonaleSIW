...
public class SchedaController {
    ...
    public SchedaController(EsercizioSchedaService esercizioSchedaService, CredentialsService credentialsService,
            ...
            PersonalTrainerService personalTrainerService, EsercizioService esercizioService) {
    ...
    public String creaScheda(@Valid @ModelAttribute("scheda") SchedaAllenamento scheda, BindingResult bindingResult,
            @RequestParam Long userId, @RequestParam(required = false) Long ptId, Model model) {
    ...
    public String modificaScheda(@PathVariable("id") Long id,
            @Valid @ModelAttribute("scheda") SchedaAllenamento schedaNuova, BindingResult bindingResult,
            @RequestParam Long userId, @RequestParam(required = false) Long ptId, Model model) {
        if (bindingResult.hasErrors()) {
            model.addAttribute("ptList", this.personalTrainerService.findAll());
    ...
    public String addEsScheda(@PathVariable("id") Long id,
            @Valid @ModelAttribute("esercizioScheda") EsercizioScheda esercizioScheda, BindingResult bindingResult,
            @RequestParam Long esercizioId, Model model) {
        SchedaAllenamento scheda = schedaAllenamentoService.findById(id);
        if (bindingResult.hasErrors()) {
            model.addAttribute("scheda", scheda);
        ...
        this.esercizioSchedaService.save(id, esercizioId, esercizioScheda.getSerie(), esercizioScheda.getRipetizioni(),
