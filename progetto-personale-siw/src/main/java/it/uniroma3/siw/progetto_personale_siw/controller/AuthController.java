...
public class AuthController {
    ...
    public String showLoginForm(Model model, HttpServletRequest request) {
        ...
        if (session != null) {
            String loginError = (String) session.getAttribute("loginError"); //Leggo eventuale errore messo dal failure handler
            if (loginError != null) {
                model.addAttribute("errorMessage", loginError); //Aggiungo messaggio al modello, quindi lo passo al template
