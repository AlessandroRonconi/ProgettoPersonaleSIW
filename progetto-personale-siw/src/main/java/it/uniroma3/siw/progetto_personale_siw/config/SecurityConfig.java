...
public class SecurityConfig {
    ...
    public SecurityConfig(DataSource dataSource, CustomAuthenticationFailureHandler customAuthenticationFailureHandler) {
    ...
    public UserDetailsService userDetailsService() {
        ...
        //Quando un utente fa login, vai nel database e usa queste query per trovare password e ruolo
